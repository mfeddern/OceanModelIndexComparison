...
GLORY_Rec_Yellow_Tail.df <- left_join(
  Scaled_Filtered_Glory_Yellow_Tail.df,
  Recruitment_Yellow_Tail.df,
  by = "year"
)
...
```{r}
gamM1C1<-gamoutput("MOM6", "Tcop", MOM6_Rec_Yellow_Tail.df)
gamM2C1<-gamoutput("GLORY", "Tcop", GLORY_Rec_Yellow_Tail.df)
gamM1C2<-gamoutput("MOM6", "Tcop", GLORY_Rec_Yellow_Tail.df)
gamM2C2<-gamoutput("GLORY", "Tcop", MOM6_Rec_Yellow_Tail.df)

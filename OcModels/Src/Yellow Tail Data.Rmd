...
MOM6plot_function_by_season <- function(variable_name, season_name, dataframe, plot_title, y_axis) {
  ...
  levels <- c("GLORY", "MOM6")  # consistent legend levels
  ...
  dataframe %>%
    ...
    scale_x_continuous(breaks = seq(min(dataframe$year), max(dataframe$year), by = 5)) +
    scale_color_manual(
  values = c("GLORY" = "red", "MOM6" = "#00BFC4"),
  limits = c("GLORY", "MOM6"),
  drop = FALSE
) +
...
```{r}
plot_YV <- make_all_seasons_plot("Long Shore Transport", season_codes_YV, Season_combined.df)
print(plot_YV)
```
...
cov3<- cov(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(MLDpart),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(MLDpart))

cov4<- cov(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(MLDlarv),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(MLDlarv))

cov5<- cov(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(MLDpjuv),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(MLDpjuv))

cov6<- cov(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(LSTlarv),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(LSTlarv))

cov7<- cov(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(LSTpjuv),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(LSTpjuv))

cov8<- cov(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(CSTlarv),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(CSTlarv))

cov9<- cov(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(CSTpjuv),
...
cor3<- cor(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(MLDpart),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(MLDpart))

cor4<- cor(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(MLDlarv),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(MLDlarv))

cor5<- cor(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(MLDpjuv),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(MLDpjuv))

cor6<- cor(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(LSTlarv),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(LSTlarv))

cor7<- cor(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(LSTpjuv),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(LSTpjuv))

cor8<- cor(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(CSTlarv),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(CSTlarv))

cor9<- cor(Full_Glory_Yellow_Tail.df%>%filter(source=="GLORY")%>%select(CSTpjuv),
Full_MOM6_Yellow_Tail.df%>%filter(source=="MOM6")%>%select(CSTpjuv))

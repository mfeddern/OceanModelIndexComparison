...
ggsave("Figure2.png", plot = facet_version_annual_plot_scaled, width = 9, height = 7.5, dpi = 300)
ggsave("Figure2.pdf", plot = facet_version_annual_plot_scaled, width = 9, height = 7.5, dpi = 300)
...
ggsave("Figure3.png", plot = facet_version_annual_plot_unscaled, width = 9, height = 7.5, dpi = 300)
ggsave("Figure3.pdf", plot = facet_version_annual_plot_unscaled, width = 9, height = 7.5, dpi = 300)
...
make_plot <- function(var_name) {
  ...
  ggplot(df, aes(x = year, y = value, color = source)) +
    ...
    labs(
      ...
      color = "Ocean Model"  # Label for the color legend
    ) +
    scale_x_continuous(
...
```{r}
plot_YV <- make_all_seasons_plot("Longshore transport", season_codes_YV, Season_combined.df)
print(plot_YV)
```
...
facet_yv_seasonal <- facet_version_season_plot(
  ...
  var_plot_name = "Longshore transport"
)
...
ggsave(filename = "Figure8.png", plot = partial_effects, width = 8, height = 6, dpi = 300)
ggsave(filename = "Figure8.pdf", plot = partial_effects, width = 8, height = 6, dpi = 300)
partial_effects
```

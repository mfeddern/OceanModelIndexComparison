...
ggsave(filename = "Figure7.png", plot = plot_mld, width = 8, height = 5, dpi = 300)
print(plot_mld)
```

```{r}
plot_temp <- make_all_seasons_plot("Temperature", season_codes_Temp, Season_combined.df) 
ggsave(filename = "Figure4.png", plot = plot_temp, width = 8, height = 5, dpi = 300)
print(plot_temp)
```

```{r}
plot_XV <- make_all_seasons_plot("Cross-shelf transport", season_codes_XV, Season_combined.df)
ggsave(filename = "Figure5.png", plot = plot_XV, width = 8, height = 5, dpi = 300)
print(plot_XV)
```

```{r}
plot_YV <- make_all_seasons_plot("Longshore transport", season_codes_YV, Season_combined.df)
ggsave(filename = "Figure6.png", plot = plot_YV, width = 8, height = 5, dpi = 300)
print(plot_YV)
```

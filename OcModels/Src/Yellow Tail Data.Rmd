...
```{r}
gamM1C1<-gamoutput("Model 1", "covariate1", LongScaled_CombinedModels_Rec_Yellow_Tail.df)
gamM2C1<-gamoutput("Model 2", "covariate1", LongScaled_CombinedModels_Rec_Yellow_Tail.df)
gamM1C2<-gamoutput("Model 1", "covariate2", LongScaled_CombinedModels_Rec_Yellow_Tail.df)
gamM2C2<-gamoutput("Model 2", "covariate2", LongScaled_CombinedModels_Rec_Yellow_Tail.df)


unique(LongScaled_CombinedModels_Rec_Yellow_Tail.df$Model)
